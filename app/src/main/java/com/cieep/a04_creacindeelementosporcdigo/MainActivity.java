...
public class MainActivity extends AppCompatActivity {
    ...
    private void pintarElementos() {
        ...
        for (Alumno alumno : alumnosList) {
            ...
            View alumnoView = LayoutInflater.from(MainActivity.this).inflate(R.layout.alumno_model, null);
            // Tomo posesión de los elementos de la vista de la fila de alumno
            TextView lblNombre = alumnoView.findViewById(R.id.lbl_Nombre_Alumno_ModelView);
            TextView lblApellidos = alumnoView.findViewById(R.id.lbl_Apellido_Alumno_ModelView);
            TextView lblCiclo = alumnoView.findViewById(R.id.lbl_Ciclo_Alumno_ModelView);
            TextView lblGrupo = alumnoView.findViewById(R.id.lbl_Grupo_Alumno_ModelView);
